 ...
 * </p>
 * Created by Nathen On 2016/06/02 00:01
 */
public class MTextureView extends TextureView {

	protected static final String	TAG					= "MTextureView";
	...
	@Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (parentWidth != 0 && parentHeight != 0 && videoWidth != 0 && videoHeight != 0) {
			if (PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE == PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE_FILL_PARENT) {
		...
		if (parentWidth != 0 && parentHeight != 0 && videoWidth != 0 && videoHeight != 0) {
			if (PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE == PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE_ORIGINAL) {
				/** 原图 **/
				height = videoHeight;
				width = videoWidth;
			} else if (PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE == PlayerConstant.VIDEO_IMAGE_DISPLAY_TYPE_FILL_SCROP) {
				if (viewRotation == 90 || viewRotation == 270) {
					int tempSize = parentWidth;
					parentWidth = parentHeight;
					parentHeight = tempSize;
